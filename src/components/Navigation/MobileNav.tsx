    ...
    <div className='cursor-pointer sm:hidden'>
      ...
      {isOpen ? (
        <>
          ...
          <div className='fixed top-20 bottom-0 left-0 min-w-[50%] min-h-[calc(100vh-5rem)] overflow-y-auto scrollbar-w-2::-webkit-scrollbar scrollbar-track-blue-lighter::-webkit-scrollbar-track scrollbar-thumb-blue::-webkit-scrollbar-thumb scrollbar-thumb-rounded::-webkit-scrollbar-thumb'>
            <div className='navbar-backdrop fixed inset-0 bg-coolGray-900 opacity-60' />
            <div className='relative bg-white min-h-full'>
              <div className='pt-5 '>
                ...
                <ul className='px-4 mb-8'>
                  <li>
                    <a
                      className='p-3 py-4 flex items-center justify-between text-coolGray-500 hover:text-green-500 hover:bg-coolGray-50 rounded-md'
                      href='#'
                    >
                      <div className='flex items-center'>
                        ...
                        <p className='text-coolGray-800 font-medium text-base'>
                          Dashboard
                        </p>
                      </div>
                      <svg
                  ...
                  <li>
                    ...
                    >
                      <div className='flex items-center'>
                        <p className='text-coolGray-300 font-medium text-base'>
                          Notifications
                        </p>
                      </div>
                    </a>
              ...
              <ul className='px-4 pb-10'>
                ...
                <div className='flex flex-wrap items-center p-4 justify-between bg-white'>
