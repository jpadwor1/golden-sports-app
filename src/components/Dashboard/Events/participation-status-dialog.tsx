      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="min-h-[500px] max-h-[500px]">
          ...
          <Tabs defaultValue={defaultTab} className="w-full">
            ...
            <TabsContent
              value="attending"
              className="p-4 max-h-[300px] min-h-[300px] overflow-y-auto justify-start self-start"
            >
              ...
              {/* {attendingParticipants.map((user: Participant) => (
                ...
                >
                  <Avatar>
                    <AvatarImage
                      src={user.user.imageURL ? user.user.imageURL : ""}
            ...
            <TabsContent
              value="all"
              className="p-4 max-h-[300px] min-h-[300px] w-full flex flex-col justify-start self-start overflow-y-auto"
            >
              {isLoading && <p>Loading...</p>}
