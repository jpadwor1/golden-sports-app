...
const MiniEventCard = () => {
  return (
    <div className='flex lg:flex-row flex-wrap w-full items-center justify-center my-2 border-l-2 border-blue-600 hover:bg-gray-100 hover:cursor-pointer'>
      ...
      <div className='flex flex-col items-start'>
        ...
        <div className='flex flex-row items-center justify-between'>
          <CalendarCheck className='lg:block hidden h-4 w-4 text-blue-500 mx-1' />
          <p className='lg:block hidden text-xs text-gray-500'>
            Thursday, Feb 29, 2024 at 6:00 PM
          </p>
          <p className='lg:hidden block text-xs text-gray-500 truncate ml-1'>
            Wednesday Practice
          </p>
        </div>
      </div>
